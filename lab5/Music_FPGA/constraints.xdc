...
#set_property PACKAGE_PIN W16 [get_ports w_pressed]
#set_property IOSTANDARD LVCMOS33 [get_ports w_pressed]
#set_property PACKAGE_PIN V16 [get_ports s_pressed]
#set_property IOSTANDARD LVCMOS33 [get_ports s_pressed]
#set_property PACKAGE_PIN T17 [get_ports r_pressed]
#set_property IOSTANDARD LVCMOS33 [get_ports r_pressed]
## Switches
...
# set_property PACKAGE_PIN W3 [get_ports {ibeatNum[0]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {ibeatNum[0]}]
# set_property PACKAGE_PIN U3 [get_ports {ibeatNum[1]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {ibeatNum[1]}]
# set_property PACKAGE_PIN P3 [get_ports {ibeatNum[2]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {ibeatNum[2]}]
# set_property PACKAGE_PIN N3 [get_ports {ibeatNum[3]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {ibeatNum[3]}]
# set_property PACKAGE_PIN P1 [get_ports {ibeatNum[4]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {ibeatNum[4]}]
...
#set_property IOSTANDARD LVCMOS33 [get_ports {rst}]
#btnU
#set_property PACKAGE_PIN T18 [get_ports {w_pressed}]
#set_property IOSTANDARD LVCMOS33 [get_ports {w_pressed}]
#btnL
#set_property PACKAGE_PIN W19 [get_ports {s_pressed}]
#set_property IOSTANDARD LVCMOS33 [get_ports {s_pressed}]
#btnR
#set_property PACKAGE_PIN T17 [get_ports {r_pressed}]
#set_property IOSTANDARD LVCMOS33 [get_ports {r_pressed}]
